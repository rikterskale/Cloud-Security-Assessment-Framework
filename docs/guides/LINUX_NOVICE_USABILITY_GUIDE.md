...
**Command ID:** `LNX-CMD-018` · **Run in:** bash · **Working directory:** repo folder · **Privilege:** standard user · **Internet:** not required · **Safe to copy/paste:** yes · **Side effects:** changes checked-out code · **Validation status:** statically verified
...
- **Known limitations:** cloud assessments require your own read-only credentials and were not exercised; rollback uses tag `v1.1.0` (see section 25).
